...
public class ShowCategoryRooms extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_category_rooms);

        recyclerView = findViewById(R.id.showCategoryRooms2);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

        searchCategory = findViewById(R.id.valueCateg);
